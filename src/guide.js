...
を"Safari"で開いて、画像の手順の通りに操作することでホームにアプリを追加できます。追加することでネイティブアプリのような感覚で起動できます。`,
    ...
    {
        title: "マクロ機能の使い方",
        sentence: `あらかじめ決まっているタスクには「マクロ」機能を使いましょう。
タスク名・頻度・締め切りまでの日数を入力して保存すると、設定した頻度で自動的にタスクが追加されます。

注意
・タスクがすぐに追加されない場合は、ページを更新してみてください。
・マクロ機能はログイン状態でないとご利用いただけません。`,
        image_src: ["/images/macro.jpg",],
    },
    {
        title: "ショートカット機能の紹介",
        sentence: `「スワイプ機能」
